# LaFleur Marketing Legal Website Template
This is a template for LaFleur Marketing to ujse to launch small websites quickly with a Payload backend and NextJS Front End.

It extends the official [Payload Website Template](https://github.com/payloadcms/payload/blob/main/templates/website).

## Quick Start
To spin up this example locally, follow these steps:

### Clone
From this [repo on GitHub](https://github.com/elilemons/lfmc-payload), select "Use this template" and "Create a new Repository".
